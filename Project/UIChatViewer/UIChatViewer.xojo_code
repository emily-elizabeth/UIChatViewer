...
Inherits DesktopHTMLViewer
	...
	#tag Constant, Name = ContactJoined, Type = String, Dynamic = False, Default = \"contact_joined", Scope = Public
	#tag EndConstant

	#tag Constant, Name = ContactKicked, Type = String, Dynamic = False, Default = \"contact_kicked", Scope = Public
	#tag EndConstant

	#tag Constant, Name = ContactLeft, Type = String, Dynamic = False, Default = \"contact_left", Scope = Public
	#tag EndConstant
	...
	#tag Constant, Name = NickChanged, Type = String, Dynamic = False, Default = \"nick_changed", Scope = Public
	#tag EndConstant

	#tag Constant, Name = Notification, Type = String, Dynamic = False, Default = \"notification", Scope = Public
	#tag EndConstant
